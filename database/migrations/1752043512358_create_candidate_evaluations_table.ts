...
export default class extends BaseSchema {
  ...
  async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.enum('recommendation', ['Proceed to next round', 'Consider with caution', 'Do not proceed']).notNullable()
      ...
      table.foreign('cv_submission_id').references('id').inTable('cv_submissions').onDelete('CASCADE')
