...
export const ASSESSMENT_QUESTIONS: AssessmentQuestion[] = [
  ...
  },
  {
    ...
    translations: {
      en: {
        ...
        description: 'Your approach to handling additional work responsibilities and time commitments.',
        options: [
      ...
      vi: {
        ...
        description: 'Cách tiếp cận của bạn đối với trách nhiệm công việc bổ sung và cam kết thời gian.',
        options: [
  ...
  },
  {
    ...
    required: true,
    validation: {
      options: ['public_recognition', 'financial_rewards', 'career_advancement', 'personal_feedback', 'team_appreciation']
    },
    scoring: {
      maxPoints: 20,
      criteria: {
    ...
    translations: {
      ...
      vi: {
        title: 'Loại ghi nhận hoặc phần thưởng nào khiến bạn cảm thấy được trân trọng nhất tại nơi làm việc?',
        description: 'Hiểu rõ điều gì thúc đẩy và tạo động lực cho bạn trong môi trường chuyên nghiệp.',
        options: [
  ...
  },
  {
    ...
    required: true,
    validation: {
      options: ['embrace_learn', 'analyze_improve', 'discuss_clarify', 'defensive_initially', 'prefer_positive']
    },
    scoring: {
      maxPoints: 20,
      criteria: {
    ...
    translations: {
      en: {
        ...
        description: 'Your approach to receiving and processing challenging feedback from supervisors or colleagues.',
        options: [
      ...
      vi: {
        ...
        description: 'Cách tiếp cận của bạn khi nhận và xử lý phản hồi thách thức từ cấp trên hoặc đồng nghiệp.',
        options: [
  ...
  },
  {
    ...
    translations: {
      en: {
        ...
        description: 'Share details about what you learned, how you approached it, and how it has benefited you professionally.',
        placeholder: 'Example: I learned React.js through online courses and built a personal project. This helped me understand modern web development and improved my problem-solving skills...'
      },
      vi: {
        title: 'Mô tả một trải nghiệm học tập gần đây hoặc kỹ năng bạn đã phát triển trong năm qua.',
        description: 'Chia sẻ chi tiết về những gì bạn đã học, cách bạn tiếp cận và nó đã mang lại lợi ích gì cho bạn trong công việc.',
        placeholder: 'Ví dụ: Tôi đã học React.js thông qua các khóa học trực tuyến và xây dựng một dự án cá nhân. Điều này giúp tôi hiểu về phát triển web hiện đại và cải thiện kỹ năng giải quyết vấn đề...'
      }
    }
  },
  {
    ...
    required: true,
    validation: {
      options: ['growth_opportunities', 'company_culture', 'work_life_balance', 'compensation_benefits', 'meaningful_work', 'team_relationships']
    },
    scoring: {
      maxPoints: 20,
      criteria: {
    ...
    translations: {
      en: {
        ...
        description: 'Consider what aspects of a workplace environment contribute most to your job satisfaction and loyalty.',
        options: [
      ...
      vi: {
        ...
        description: 'Xem xét những khía cạnh nào của môi trường làm việc đóng góp nhiều nhất vào sự hài lòng và lòng trung thành trong công việc của bạn.',
        options: [
...
export function calculateAssessmentScore(responses: Record<string, any>): {
  ...
  ASSESSMENT_QUESTIONS.forEach(question => {
    ...
    if (response) {
      if (question.type === 'multiple_choice' && question.scoring.criteria[response]) {
      ...
      } else if (question.type === 'text' && response.length >= (question.validation.minLength || 0)) {
        ...
        if (response.length >= 200) {
          ...
          score = question.scoring.criteria.general_examples || Math.floor(question.scoring.maxPoints * 0.75)
        } else if (response.length >= 50) {
          score = question.scoring.criteria.vague_response || Math.floor(question.scoring.maxPoints * 0.5)
        } else {
          score = question.scoring.criteria.minimal_effort || Math.floor(question.scoring.maxPoints * 0.25)
        }
      }
    }
