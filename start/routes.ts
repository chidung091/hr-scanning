...
// Admin Dashboard (direct access, no authentication)
router.get('/admin', [AdminController, 'dashboard'])

// Admin API Routes (direct access, no authentication)
...
router.put('/api/admin/applicants/:submissionId/status', [AdminController, 'updateApplicantStatus'])
